...
import { Type, isBlank, isPresent, BaseException, normalizeBlank, stringify, isArray, isPromise } from 'angular2/src/facade/lang';
...
export let Compiler = class {
    ...
    compile(component) {
        ...
        var pvPromise = isPromise(pvOrPromise) ? pvOrPromise :
