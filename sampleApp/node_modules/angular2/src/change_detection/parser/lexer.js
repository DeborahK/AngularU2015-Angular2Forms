...
var Token = (function () {
    ...
    Token.prototype.isNumber = function () { return (this.type == TOKEN_TYPE_NUMBER); };
    Token.prototype.isString = function () { return (this.type == TOKEN_TYPE_STRING); };
    Token.prototype.isOperator = function (operater) {
        return (this.type == TOKEN_TYPE_OPERATOR && this.strValue == operater);
    };
    Token.prototype.isIdentifier = function () { return (this.type == TOKEN_TYPE_IDENTIFIER); };
    Token.prototype.isKeyword = function () { return (this.type == TOKEN_TYPE_KEYWORD); };
    Token.prototype.isKeywordVar = function () { return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "var"); };
    Token.prototype.isKeywordNull = function () { return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "null"); };
    Token.prototype.isKeywordUndefined = function () {
        return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "undefined");
    };
    Token.prototype.isKeywordTrue = function () { return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "true"); };
    Token.prototype.isKeywordIf = function () { return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "if"); };
    Token.prototype.isKeywordElse = function () { return (this.type == TOKEN_TYPE_KEYWORD && this.strValue == "else"); };
