...
export declare class Directive extends Injectable {
     ...
     */
    exportAs: string;
    constructor({selector, properties, events, host, lifecycle, hostInjector, exportAs, compileChildren}?: ComponentArgs);
}
...
export declare class Component extends Directive {
    ...
    constructor({selector, properties, events, host, exportAs, appInjector, lifecycle, hostInjector, viewInjector, changeDetection, compileChildren}?: DirectiveArgs);
}
