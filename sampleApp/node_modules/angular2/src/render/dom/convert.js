...
function directiveMetadataFromMap(map) {
    return new api_1.DirectiveMetadata({
        ...
        exportAs: collection_1.MapWrapper.get(map, 'exportAs'),
        ...
        events: _cloneIfPresent(collection_1.MapWrapper.get(map, 'events')),
        changeDetection: collection_1.MapWrapper.get(map, 'changeDetection'),
    });
}
