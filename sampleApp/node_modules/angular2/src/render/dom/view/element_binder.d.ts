...
export declare class ElementBinder {
    ...
    constructor({textNodeIndices, contentTagSelector, nestedProtoView, componentId, eventLocals, localEvents, globalEvents, hostActions, parentIndex, distanceToParent, propertySetters, elementIsEmpty}?: {
        contentTagSelector?: string;
        textNodeIndices?: List<number>;
        nestedProtoView?: protoViewModule.DomProtoView;
        eventLocals?: AST;
